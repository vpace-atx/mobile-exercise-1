...
class Manifest {
    ...
    async #setManifestPath() {
        if (!this.#manifestPath) {
            ...
            /* istanbul ignore if */
            if (path_1.default.relative(this.#appiumHome, this.#manifestPath).startsWith('.')) {
    ...
    async write() {
        ...
        this.#writing = (async () => {
            await this.#setManifestPath();
            try {
                await support_1.fs.mkdirp(path_1.default.dirname(this.#manifestPath));
            }
            catch (err) {
                throw new Error(`Appium could not create the directory for the manifest file: ${path_1.default.dirname(this.#manifestPath)}. Original error: ${err.message}`);
            }
            try {
                await support_1.fs.writeFile(this.#manifestPath, yaml_1.default.stringify(this.#data), 'utf8');
                return true;
            }
            catch (err) {
