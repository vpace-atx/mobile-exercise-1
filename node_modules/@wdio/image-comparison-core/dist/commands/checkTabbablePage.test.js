...
describe('checkTabbablePage', () => {
    ...
    it('should throw error when used in native context', async () => {
        ...
        await expect(checkTabbablePage(options)).rejects.toThrow('The method checkTabbablePage is not supported in native context for native mobile apps!');
    });
