...
describe('checkFullPageScreen', () => {
    ...
    it('should throw error when used in native context', async () => {
        ...
        await expect(checkFullPageScreen(options)).rejects.toThrow('The method checkFullPageScreen is not supported in native context for native mobile apps!');
    });
    ...
    it('should handle hideAfterFirstScroll correctly', async () => {
        const mockElement = { elementId: 'hide-element', selector: '#hide' };
        const options = {
            ...baseOptions,
            checkFullPageOptions: {
                ...baseOptions.checkFullPageOptions,
