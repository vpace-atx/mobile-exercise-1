 ...
 */
export declare function resolveExecuteExtensionName<C extends Constraints>(this: BaseDriver<C>, commandName: string): string;
//# sourceMappingURL=extension-command-name.d.ts.map