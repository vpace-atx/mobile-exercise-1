...
declare namespace systemCallMethods {
     ...
     */
    function waitForDevice(this: import("../idb.js").default, timeoutMs?: number): Promise<void>;
    /**
     ...
     */
    function exec(this: import("../idb.js").default, cmd: string[], args?: string[], opts?: import("teen_process").TeenProcessExecOptions & {
     ...
     */
    function createSubProcess(this: import("../idb.js").default, command?: string[], args?: string[], opts?: import("teen_process").SubProcessOptions): import("teen_process").SubProcess;
}
