 ...
 */
export function connect(this: import("../remote-debugger").RemoteDebugger, timeout?: number): Promise<import("../types").AppDict>;
/**
 *
 * @this {RemoteDebugger}
 * @returns {Promise<void>}
 ...
 */
export function selectApp(this: import("../remote-debugger").RemoteDebugger, currentUrl?: string | null, maxTries?: number, ignoreAboutBlankUrl?: boolean): Promise<import("../types").Page[]>;
/**
 *
 * @this {RemoteDebugger}
 ...
 * @returns {Promise<void>}
 */
export function selectPage(this: import("../remote-debugger").RemoteDebugger, appIdKey: import("../types").AppIdKey, pageIdKey: import("../types").PageIdKey, skipReadyCheck?: boolean): Promise<void>;
/**
